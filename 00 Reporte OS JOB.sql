SET TRAN ISOLATION LEVEL READ UNCOMMITTED;
	SELECT DISTINCT	S.NOMBRESUCURSALBRINKS,
				O.NUM_ORDENSERVICIO,
				O.NUM_SOLICITUD,
				O.COD_ESTADOORDENSERVICIO,
				E.NOMESTADOORDENSERVICIO,
				EOM.NOMBREESTADOOM,
				O.COD_TIPOORDENSERVICIO,
				T.NOMTIPOORDENSERVICIO,
				OSF.NOM_ORDENSERVICIOFAMILIA AS FAMILIA_ORDEN_SERVICIO, 
				O.MOVIMIENTO,
				CONVERT(DATE, O.FECHAORDENSERVICIO) AS FECHA_OS,
				CONVERT(DATE, O.FECHASERVICIO) AS FECHA_S,
				O.ID_CLIENTEPRINCIPAL,
				O.ID_CLIENTEDEPENDIENTE,
				O.COD_PUNTOPRINCIPAL,
				O.COD_PUNTODEPENDIENTE,
				O.COD_PUNTOORIGEN,
				NOMPUNTOORIGEN = PO.NOMBREPUNTOSERVICIO,
				O.COD_PUNTODESTINO,
				NOMPUNTODESTINO = PD.NOMBREPUNTOSERVICIO,
				O.COD_TIPOVALOR,
				NOMTIPOVALOR = TV.NOMBRETIPOVALOR,
				O.MONTOORDEN,
